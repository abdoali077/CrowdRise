...
if (currentUser) {
    ...
    if (avatar) {
        avatar.src = currentUser.profileImage || currentUser.image || `https://ui-avatars.com/api/?name=${currentUser.name}&background=4f46e5&color=fff`;
    }
}
    ...
    userCampaigns.slice(0, 3).forEach(campaign => {
        ...
        campaignsGrid.innerHTML += `
            <div class="campaign-card">
                <div class="card-img">
                    <img src="${campaign.image || '../../images/img1.png'}">
